...
podman run --name prometheus -d --pod prometheus-grafana -v $PWD/prometheus.yml:/etc/prometheus/prometheus.yml:Z -v $PWD/prometheus_volume:/prometheus:Z prom/prometheus
echo Starting grafana
podman run -d --name grafana --pod prometheus-grafana -v $PWD/grafana_volume:/var/lib/grafana:Z -v $PWD/provisioning:/etc/grafana/provisioning:Z grafana/grafana
