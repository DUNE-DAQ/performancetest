...
```[bash]
(dbt) [sbhuller@np04-srv-017 np02srv004]$ create_pinning_minimal.py -r np02-srv-004 -t cpupin-all-template.json -c
Namespace(template='cpupin-all-template.json', readout_server='np02-srv-004', cache_aware=True, rte=1, tpproc=2, rawproc=16, ccp=6, recording=6)
Error running 'ssh sbhuller@np02-srv-004 lstopo -p --of xml': b'Warning: No xauth data; using fake authentication data for X11 forwarding.\r\n'
───────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── CPU map ──────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
[
    {
        'Socket:0': [
...
─────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────── CPU pinning running ────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
{
    'daq_application': {
        '--name runp02srv004eth0': {
            'parent': '24,152,25,153,26,154',
            'threads': {
                'rte-worker-2': '2',
                'rte-worker-3': '3',
                'rte-worker-4': '4',
                'rte-worker-5': '5',
                'rawproc-0-1..': '1,129,130,131,132,133,6,134,7,135,8,136,9,137,10,138',
                'tpproc-1.': '16,144',
                'cleanup-1..': '24,152,25,153,26,154',
                'consumer-1..': '24,152,25,153,26,154',
                'recording-1..': '11,139,12,140,13,141',
                'cleanup-1.': '24,152,25,153,26,154',
                'consumer-1.': '24,152,25,153,26,154',
                'periodic-1.': '24,152,25,153,26,154'
            }
        },
        '--name runp02srv004eth1': {
            'parent': '56,184,57,185,58,186',
            'threads': {
                'rte-worker-34': '34',
                'rte-worker-35': '35',
                'rte-worker-36': '36',
                'rte-worker-37': '37',
                'rawproc-0-2..': '33,161,162,163,164,165,38,166,39,167,40,168,41,169,42,170',
                'tpproc-2.': '48,176',
                'cleanup-2..': '56,184,57,185,58,186',
                'consumer-2..': '56,184,57,185,58,186',
                'recording-2..': '43,171,44,172,45,173',
                'cleanup-2.': '56,184,57,185,58,186',
                'consumer-2.': '56,184,57,185,58,186',
                'periodic-2.': '56,184,57,185,58,186'
            }
        },
        '--name runp02srv004eth2': {
            'parent': '88,216,89,217,90,218',
            'threads': {
                'rte-worker-66': '66',
                'rte-worker-67': '67',
                'rte-worker-68': '68',
                'rte-worker-69': '69',
                'rawproc-0-3..': '65,193,194,195,196,197,70,198,71,199,72,200,73,201,74,202',
                'tpproc-3.': '80,208',
                'cleanup-3..': '88,216,89,217,90,218',
                'consumer-3..': '88,216,89,217,90,218',
                'recording-3..': '75,203,76,204,77,205',
                'cleanup-3.': '88,216,89,217,90,218',
                'consumer-3.': '88,216,89,217,90,218',
                'periodic-3.': '88,216,89,217,90,218'
            }
        },
        '--name runp02srv004eth3': {
            'parent': '120,248,121,249,122,250',
            'threads': {
                'rte-worker-98': '98',
                'rte-worker-99': '99',
                'rte-worker-100': '100',
                'rte-worker-101': '101',
                'rawproc-0-4..': '97,225,226,227,228,229,102,230,103,231,104,232,105,233,106,234',
                'tpproc-4.': '112,240',
                'cleanup-4..': '120,248,121,249,122,250',
                'consumer-4..': '120,248,121,249,122,250',
                'recording-4..': '107,235,108,236,109,237',
                'cleanup-4.': '120,248,121,249,122,250',
                'consumer-4.': '120,248,121,249,122,250',
                'periodic-4.': '120,248,121,249,122,250'
            }
        }
    }
}
...
[
    {
        'Socket:0': [
            {
                'NUMA:0': [
                    {'Cache:49': [{'Core:14': ['PU:14', 'PU:142']}, {'Core:15': ['PU:15', 'PU:143']}]},
                    {'Cache:90': [{'Core:17': ['PU:17', 'PU:145']}, {'Core:18': ['PU:18', 'PU:146']}, {'Core:19': ['PU:19', 'PU:147']}, {'Core:20': ['PU:20', 'PU:148']}, {'Core:21': ['PU:21', 'PU:149']}, {'Core:22': ['PU:22', 'PU:150']}, {'Core:23': ['PU:23', 'PU:151']}]},
                    {'Cache:131': [{'Core:27': ['PU:27', 'PU:155']}, {'Core:28': ['PU:28', 'PU:156']}, {'Core:29': ['PU:29', 'PU:157']}, {'Core:30': ['PU:30', 'PU:158']}, {'Core:31': ['PU:31', 'PU:159']}]}
                ]
            },
            {
                'NUMA:1': [
                    {'Cache:213': [{'Core:46': ['PU:46', 'PU:174']}, {'Core:47': ['PU:47', 'PU:175']}]},
                    {'Cache:254': [{'Core:49': ['PU:49', 'PU:177']}, {'Core:50': ['PU:50', 'PU:178']}, {'Core:51': ['PU:51', 'PU:179']}, {'Core:52': ['PU:52', 'PU:180']}, {'Core:53': ['PU:53', 'PU:181']}, {'Core:54': ['PU:54', 'PU:182']}, {'Core:55': ['PU:55', 'PU:183']}]},
                    {'Cache:295': [{'Core:59': ['PU:59', 'PU:187']}, {'Core:60': ['PU:60', 'PU:188']}, {'Core:61': ['PU:61', 'PU:189']}, {'Core:62': ['PU:62', 'PU:190']}, {'Core:63': ['PU:63', 'PU:191']}]}
                ]
            }
        ]
    },
    {
        'Socket:1': [
            {
                'NUMA:2': [
                    {'Cache:378': [{'Core:78': ['PU:78', 'PU:206']}, {'Core:79': ['PU:79', 'PU:207']}]},
                    {'Cache:419': [{'Core:81': ['PU:81', 'PU:209']}, {'Core:82': ['PU:82', 'PU:210']}, {'Core:83': ['PU:83', 'PU:211']}, {'Core:84': ['PU:84', 'PU:212']}, {'Core:85': ['PU:85', 'PU:213']}, {'Core:86': ['PU:86', 'PU:214']}, {'Core:87': ['PU:87', 'PU:215']}]},
                    {'Cache:460': [{'Core:91': ['PU:91', 'PU:219']}, {'Core:92': ['PU:92', 'PU:220']}, {'Core:93': ['PU:93', 'PU:221']}, {'Core:94': ['PU:94', 'PU:222']}, {'Core:95': ['PU:95', 'PU:223']}]}
                ]
            },
            {
                'NUMA:3': [
                    {'Cache:542': [{'Core:110': ['PU:110', 'PU:238']}, {'Core:111': ['PU:111', 'PU:239']}]},
                    {
                        'Cache:583': [
                            {'Core:113': ['PU:113', 'PU:241']},
                            {'Core:114': ['PU:114', 'PU:242']},
                    ...
                    {'Cache:624': [{'Core:123': ['PU:123', 'PU:251']}, {'Core:124': ['PU:124', 'PU:252']}, {'Core:125': ['PU:125', 'PU:253']}, {'Core:126': ['PU:126', 'PU:254']}, {'Core:127': ['PU:127', 'PU:255']}]}
                ]
            }
        ]
    }
...
(dbt) [sbhuller@np04-srv-017 np02srv004]$ 
```