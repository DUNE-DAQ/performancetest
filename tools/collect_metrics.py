...
def collect_metrics(args : argparse.Namespace | dict) -> None | dict:
    ...
    harvester.extract_daq_dashboards(dashboard_info, test_args["run_number"], test_args["host"], time_range, test_args["dunedaq_version"], output_file = name, out_dir = out_dir)
