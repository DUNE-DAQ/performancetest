...
fddaqconf_gen -c ../daqconfs/daqconf-eth-48streams_swtpg-np02srv003.json --detector-readout-map-file ../readoutmaps/RM-np02srv003-1-streams48.json v4_2_0-np02srv003-1-eth-48s\
treams_swtpg-np04srv025
fddaqconf_gen -c ../daqconfs/daqconf-eth-48streams_recording_swtpg-np02srv003.json --detector-readout-map-file ../readoutmaps/RM-np02srv003-1-streams48.json v4_2_0-np02srv003\
-1-eth-48streams_recording_swtpg-np04srv025
fddaqconf_gen -c ../daqconfs/daqconf-eth-48streams_recording_swtpg_multinode-np02srv003.json --detector-readout-map-file ../readoutmaps/RM-np02srv003-1-streams48.json v4_2_0-\
np02srv003-1-eth-48streams_recording_swtpg_multinode-np04srv025
#------------------- np02srv004 -----------------
...
fddaqconf_gen -c ../daqconfs/daqconf-eth-48streams_swtpg-np02srv004.json --detector-readout-map-file ../readoutmaps/RM-np02srv004-1-streams48.json v4_2_0-np02srv004-1-eth-48s\
treams_swtpg-np04srv025
fddaqconf_gen -c ../daqconfs/daqconf-eth-48streams_recording_swtpg-np02srv004.json --detector-readout-map-file ../readoutmaps/RM-np02srv004-1-streams48.json v4_2_0-np02srv004\
-1-eth-48streams_recording_swtpg-np04srv025
fddaqconf_gen -c ../daqconfs/daqconf-eth-1stream_recording_swtpg_oneL3-np02srv004.json --detector-readout-map-file ../readoutmaps/RM-np02srv004-0-stream1.json v4_2_0-np02srv0\
04-0-eth-1stream_recording_swtpg_oneL3-np04srv025