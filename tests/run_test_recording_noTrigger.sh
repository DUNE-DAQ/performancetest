...
nanorc $test_name $envir_name boot conf start $run_num expert_command --timeout 10 $test_name/$test_name/ru${server}eth${NUMA_node_num} record-cmd.json wait 1200 stop_run shutdown
